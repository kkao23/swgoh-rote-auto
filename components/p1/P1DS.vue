...
<template>
    ...
    <tr>
        <MissionTableFragment :position="`Bot (Wat)`" :data="data.ds.bottom" :phase="phase" :alignment="alignment" :helpUrl="`https://swgoh-rote.s3.us-east-2.amazonaws.com/swgoh_help/mustafar_right.jpg`"></MissionTableFragment>
    </tr>
    <tr>
        <MissionTableFragment :position="`Top (Geo)`" :data="data.ds.top" :phase="phase" :alignment="alignment" :helpUrl="`https://swgoh-rote.s3.us-east-2.amazonaws.com/swgoh_help/mustafar_mid.jpg`"></MissionTableFragment>
    </tr>
    <tr>
